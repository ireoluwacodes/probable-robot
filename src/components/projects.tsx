...
const AWSS3Icon = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 128 128" className={className}>
    <path fill="currentColor" d="M64 8L16 28v72l48 20 48-20V28L64 8zm0 8l40 16.7v58.6L64 108 24 91.3V32.7L64 16z"></path>
    <path fill="currentColor" d="M64 32L40 44v40l24 12 24-12V44L64 32zm0 8l16 8v24l-16 8-16-8V48l16-8z"></path>
  </svg>
)
